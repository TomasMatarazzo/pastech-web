...
const Titulo = ({titulo,bg}) => {
  return (
    ...
    <div className="flex relative  justify-center items-center flex-col rounded-[2%] p-16 pb-4">
        <h1 className= {` border-b-[2px] border-dashed border-first-green inline-block py-2  pb-0 text-3xl leading-[50px] max-md:text-[32px] font-bold text-first-green font-[Roboto]`}>{titulo}</h1>
    </div>
</section>
  )
}
