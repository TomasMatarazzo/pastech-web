        ...
        <div className='flex justify-center items-center xl:padding-1  max-md:pt-[20px]'>
            ...
            {data.map((item, index) => (
                <div className='flex items-center'>
                    <li key={index} className=' bg-white z-50 text-center flex flex-col items-center justify-center shadow-lg w-[300px] h-[300px] relative  max-md:w-[100%] max-md:p-8 max-md:my-8 border-first-green border-[1px] border-[50%]  rounded-full transition-all duration-500 hover:bg-slate-200 text-wrap'>
                    ...
                    <div className='w-[70%] -z-0 border absolute px-[150px] flex left-[25%] h-[250px] text-center items-center  '>
