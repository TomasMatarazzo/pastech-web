 ...
 const textos = [
  ...
  return (
    ...
    <div className={`flex relative  justify-center items-center flex-col rounded-[2%] max-md:text-center`}>
        <h1 className= {` inline-block max-md:px-16   pb-0 text-2xl leading-[30px] max-md:text-[20px] font-bold text-t-green font-[Roboto]`}>Mediciones remotas de stock de pasto con drones y algoritmos de calibración</h1>
    </div>
