    ...
    <section
      ...
      <div className='group-hover:block absolute top-[50%] -translate-x-0 translate-y-[-50%] right-5 text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer'>
        ...
        <div className = {` font-["Roboto"] absolute max-md:top-[60%] max-md:left-10 top-2/3 left-[50%] `}>
          <h1 className={`max-md:text-2xl max-md:border-0 ${slides[index].wrap} border-solid border-b-4 border-t-green text-[#fff] font-[Lato] z-5 min-w-64 max-w-min whitespace-normal text-[60px] opacity-1 font-extrabold cursor-pointer transition-none ease`}>{slides[index].texto}</h1>
